<template>
  ...
  <div class="dark:text-gray-100 text-grayLightMode-400 px-5 pb-3 rounded-curl">
    <div class="">
      <div class="flex justify-between">
        ...
        <!-- only show `menu` buttons if the current loggedin user  is not the user they are viewing their profile -->
        <!-- menu button -->
        <svg
        ...
        <!--/ menu button -->
        <!-- if the user is viewing their own `followers` and `following` lists, show them an edit button -->
  ...
  <!--/ user profile section -->
  <div
    class="dark:bg-gray-800 bg-grayLightMode-100 p-3 dark:text-gray-100 text-grayLightMode-400 rounded-curl flex space-x-3 w-full mb-3"
  >
    <router-link
      :to="`/u/` + userName + `/followers`"
      class="py-3 w-full rounded-curl cursor-pointer text-center my-auto"
      :class="whichRouteWeOn() == `FollowersView` ? `dark:bg-gray-700` : ``"
    >
      <div class="font-bold">Followers</div>
    </router-link>
    <router-link
      :to="`/u/` + userName + `/following`"
      :class="whichRouteWeOn() == `FollowingView` ? `dark:bg-gray-700` : ``"
      class="py-3 w-full rounded-curl cursor-pointer text-center my-auto"
    >
